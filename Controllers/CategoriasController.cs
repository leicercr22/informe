...
namespace Informedebasedatos.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(InformedebasedatosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'InformedebasedatosContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InformedebasedatosContext.Categoria'  is null.");
            }
            var categoria = await _context.Categoria.FindAsync(id);
            if (categoria != null)
            {
